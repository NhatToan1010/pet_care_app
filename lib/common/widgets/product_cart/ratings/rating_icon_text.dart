  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        Text(
          ' ${ratingScore! > 0 ? ratingScore.toString() : 'Chưa có đánh giá'}',
          style: ratingScore! > 0 ? Theme.of(context).textTheme.titleSmall?.apply(color: fontColor) : Theme.of(context).textTheme.bodyLarge?.apply(color: fontColor),
        ),
      ],
    );
  }
